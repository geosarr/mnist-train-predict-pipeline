...
def training(n_train:int, 
    ...
    train_losses, val_losses = run_train(n_epochs=n_epochs, 
    ...
    return FileResponse(path="./results/losses.png", 
                        filename="losses.png", 
                        media_type="")
...
def prediction(run: bool):
    if run:
        run_predict()
        return FileResponse(path="./results/predictions.txt", 
